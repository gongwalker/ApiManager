!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("app/static/vue")) : "function" == typeof define && define.amd ? define("ELEMENT", ["app/static/vue"], t) : "object" == typeof exports ? exports.ELEMENT = t(require("app/static/vue")) : e.ELEMENT = t(e.Vue)
...
new Vue({
    ...
    methods: {
        ...
        , SignIn() {
            ...
            if (validSwitch && !username) {
                this.$notify.error({
                    title: 'error',
                    message: 'Please input username'
                });

            } else if (validSwitch && !password) {
                this.$notify.error({
                    title: 'error',
                ...
                this.$http.post('/login', {
                    ...
                    localStorage.setItem("USER_NAME", res.body.data.login_name)
                    localStorage.setItem("USER_ROLE", res.body.data.role)
                    location.href = "/"
                }, function (res) {
                    this.$message({
                        message: res.body.msg,
