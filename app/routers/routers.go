...
func InitRouter() *gin.Engine {
	...
	// uploads served from DB (public) - wildcard to support optional year-month
	r.GET("/uploads/*path", controllers.ServeUploadByFilename)
	...
	api := r.Group("/api")
	{
		...
		api.POST("/upload", roleMiddleWare(2), controllers.UploadImage)
	}
